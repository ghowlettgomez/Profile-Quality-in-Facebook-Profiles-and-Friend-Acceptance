...
with open('full_profile_edited.txt', 'w') as edited:
    edited.write(replaceProfilePic(profile))


def alterSmallRequest (name, friends):
    if friends <= 0:
        mutual = ''
    else:
...
print(alterSmallRequest('ABC DEF', 0))
